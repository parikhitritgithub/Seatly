...
const App = () => {
  ...
  const isadminpanel = useLocation().pathname.startsWith('/admin'); // if we are in the admin dashbord we need to hide he nav bar 
  return (
    <>
      <Toaster/>
     { /* this nav bar display whenever we are in the user page but whenever we go to the admin dashboard we have to hide this navbar */}
      {!isadminpanel && <Navbar />} 
      <Routes>
